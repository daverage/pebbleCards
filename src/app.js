...
var cardsObj = { cards : [
			...
			desc : "No one uses manuals any more! Help people get used to your system with a nice tutorial or a gentle introduction on how everything works."
			},{
			category : "General",
			title : "Signposting",
			...
			desc : "No one likes to lose anything they have earned. Fear of losing status, friends, points, achievements, possessions, progress etc. can be a powerful reason for people to act."
			},{
			category : "General",
			title : "Progress / Feedback",
			img : "IMAGES_16_PROGRESS_PNG",
			desc : "Progress and feedback come in many forms and have many mechanisms available. All User Types need some sort of measure of progress or feedback, but some types work better than others do."
			},{
			category : "General",
			title : "Theme",
			...
			desc : "Surprise and delight people with unexpected re-wards. Keep them on their toes and maybe even make them smile."
			},{
			category : "Schedules",
			title : "Fixed Reward Schedule",
			img : "IMAGES_11_FIXED_REWARD_SCHEDULE_PNG",
			desc : "Reward people based on defined actions and events. First activity, level up, progression. Useful during onboarding and to celebrate milestone events."
			},{
			category : "Schedules",
			...
			desc : "Allow people to connect and be social with an easy to use and accessible social network. It can be more fun to play with other people than to play on your own."
			},{
			category : "Socialiser",
			title : "Social Status",
			...
			desc : "A way to find people and to be found is essential for building new relationships. Matching people based on interests and status can all help get people started."
			},{
			category : "Socialiser",
			...
			desc : "Add to the feeling of self-expression and value, by offering unlockable or rare content for Free Spirits to use. Linked to Easter eggs and exploration as well as achievement."
			},{
			category : "Free Spirit",
			title : "Creativity Tools",
			img : "IMAGES_35_CREATIVITY_TOOLS_PNG",
			desc : "Allow people to create their own content and ex-press themselves. This may be for personal gain, for pleasure or to help other people (teaching materials, levels, gear, FAQ etc.)."
			},{
			category : "Free Spirit",
			title : "Customisation",
			...
			desc : "Levels and goals help to map a user’s progression through a system. It is as important to see where you can go as it is to see where you have been."
			},{
			category : "Achiever",
			title : "Boss Battles",
			...
			desc : "Physical rewards and prizes can promote lots of activity and when used well, can cre-ate engagement. Be careful of promoting quantity over quality."
			},{
			category : "Player",
			...
			desc : "Sometimes you just have to burn it all to the ground and start again. Sit back, throw the rulebook out of the window and see what happens! Consider running short \"no rules\" events."
			}
	  ]};
...
function loadCard(r){
  ...
  var cardImage=cardsObj.cards[r].img;
  card.banner(cardImage);
